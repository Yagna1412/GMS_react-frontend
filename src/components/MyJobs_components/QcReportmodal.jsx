...
function QcReportModal({ job, onClose }) {
  ...
  const serviceCost = job.services.reduce((s, i) => s + i.price, 0);
        ...
        <div className="px-8 pb-6 grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-5 rounded-xl">
              <h3 className="text-blue-900 font-semibold mb-2">Vehicle Info</h3>
              <p className="text-gray-500">Model: {job.vehicle}</p>
              <p className="text-gray-500">Reg No: {job.carNumber}</p>
            </div>

            <div className="bg-blue-50 p-5 rounded-xl">
              <h3 className="text-blue-900 font-semibold mb-2">Technician</h3>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-blue-200 rounded-full flex items-center justify-center font-bold text-blue-700">
                  {job.mechanic?.[0]}
                </div>
                <div>
                  <p className="font-semibold text-gray-700">{job.mechanic}</p>
                  <p className="text-xs text-gray-400">Master Mechanic</p>
                </div>
              </div>
            </div>
            ...
            <table className="w-full text-sm">
              <tbody>
                ...
                <tr className="border-b">
                  ...
                  <td className="py-2 text-right">₹{serviceCost}</td>
                </tr>
                ...
                <tr className="border-b">
                  ...
                  <td className="py-2 text-right">₹{tax}</td>
                </tr>
